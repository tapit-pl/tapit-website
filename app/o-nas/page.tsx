...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <div className="space-y-5 text-[#b0ada5] text-base leading-relaxed">
                <p>
      ...
      {/* Values */}
      <section className="py-20 bg-[rgba(0,0,0,0.02)] border-y border-[rgba(255,255,255,0.07)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map(v => (
              <div
                key={v.title}
                className="bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-8 text-center hover:border-accent/20 hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <h3 className="font-heading font-bold text-lg text-[#f8f7f4] mb-3">{v.title}</h3>
                <p className="text-[#b0ada5] text-sm leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-[#b0ada5] text-lg max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
          {team.map(member => (
            <div
              key={member.name}
              className="group bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-6 text-center hover:border-accent/25 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <p className="font-heading font-bold text-sm text-[#f8f7f4] leading-snug">{member.name}</p>
              <p className="text-xs text-[#b0ada5] mt-1 leading-snug">{member.role}</p>
            </div>
          ))}
        </div>
      </section>
